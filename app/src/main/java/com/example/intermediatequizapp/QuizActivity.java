...
public class QuizActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_SCORE = "com.example.intermediatequizapp.extraScore";
    private static final long COUNTDOWN_IN_MILLIS = 30000;
    public static final String SCORE = "com.example.intermediatequizapp.Score";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            cscore= savedInstanceState.getInt(KEY_SCORE);
   ...
   private void showScore(){
       ...
       score = prefs.getInt(EXTRA_SCORE,score);
       intent.putExtra(EXTRA_SCORE, score);
    }
